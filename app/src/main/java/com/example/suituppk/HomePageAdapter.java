...
public class  HomePageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                View horizantalProductView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.horizontal_scroll_layout, viewGroup, false);
                return new HorizontalProductViewHolder(horizantalProductView);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        switch (homePageModelList.get(position).getType()) {
            ...
            case HomePageModel.GRID_PRODUCT_VIEW:
                ...
                ((GridProductViewHolder) viewHolder).GridProductLayout(gridProductScrollModelList, gridLayoutTitle, gridlayoutcolor);
    ...
    public class BannerSliderViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setBannerSliderViewPager(final List<sliderModel> sliderModelList) {
            ...
            bannerSliderViewPager.setCurrentItem(curentpage);
        ...
        private void pagelopper(List<sliderModel> sliderModelList) {
            ...
            if (curentpage == sliderModelList.size() - 2) {

                curentpage = 2;
                bannerSliderViewPager.setCurrentItem(curentpage, false);
            }

            if (curentpage == 1) {

                curentpage = sliderModelList.size() - 3;
                bannerSliderViewPager.setCurrentItem(curentpage, false);
            }
        ...
        public void startbannerslideshow(final List<sliderModel> sliderModelList) {
            ...
            final Runnable update = new Runnable() {
                @Override
                public void run() {
                    if (curentpage >= sliderModelList.size()) {
                        curentpage = 1;
                    }
                    bannerSliderViewPager.setCurrentItem(curentpage++, true);
                }
            };
    ...
    public class StripAdBannerViewholder extends RecyclerView.ViewHolder {
        ...
        private void setstripad(String resource, String color) {
            ...
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.drawable.nooo)).into(stripAdImage);
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder{
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            ...
            HorizontallayoutTitle = itemView.findViewById(R.id.horizontol_scroll_layout_title);
            HorizontallayoutViewAllButton = itemView.findViewById(R.id.horizontal_scroll_viewall_btn);
            horizontalRecyclerView  = itemView.findViewById(R.id.horizontol_scroll_layout_recyclerview);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder{
        ...
        @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
        private void GridProductLayout(final List<HorizontalProductScrollModel> horizontalProductScrollModelList , final String title , String color){
            ...
            for (int x=0; x < 4 ; x++){
                ...
                TextView productTitle = gridProductLayout.getChildAt(x).findViewById(R.id.hs_product_titile);
                ...
                Glide.with(itemView.getContext()).load(horizontalProductScrollModelList.get(x).getProductimage()).apply(new RequestOptions().placeholder(R.drawable.nooo)).into(productImage);
