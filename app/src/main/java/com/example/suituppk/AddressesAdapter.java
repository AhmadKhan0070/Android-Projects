...
import static com.example.suituppk.MyAccountFragment.MANAGE_ADDRESS;
import static com.example.suituppk.MyAddressesActivity.refreshItem;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull AddressesAdapter.Viewholder holder, int position) {
        ...
        holder.setdata(name, city, pinCode, selected, position, mobileNo, alternateMobileNo, flatNo, landmark, locality, state);
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setdata(String username, String city, String userPincode, Boolean selected, final int position, String mobileNo, String alternateMobileNo, String flatNo, String landmark, String locality, String state) {
